            ...
            <div id="sectionName" className="flex flex-col w-full">
                ...
                <div className="flex flex-col justify-start items-start gap-4 p-4 w-full border-t-2 border-gray-200">   
                    ...
                    <ul className="space-y-2 list-disc">                        
                        <li>
                            Total base stats range.
                            <ul className="pl-4 text-gray-600 text-sm">
                                <li>Arceus, as the pokémon in default form with the highest total base stats amount of 720, as the higher limit.</li>
                                <li>Spinda, as the fully evolved pokémon with a total base stats amount of 360, as the lower limit.</li>                                
                            </ul>
                        </li>
                        <li>
                            Self usability.
                            <ul className="pl-4 text-gray-600 text-sm">
                                <li>A team must be able to benefit from their own generated options, regardless of any opposing team.</li>
                        ...
                        <li>
                            ...
                            <ul className="pl-4 text-gray-600 text-sm">
                                ...
                                <li>Top pokemon.</li>
                                <li>Shiny bonus.</li>
                                <li>Rolled options.</li>
                                <li>Imperfect teams.</li>                                
                            </ul>
                        </li>
                        <li>
                            Limited draft.
                            <ul className="pl-4 text-gray-600 text-sm">                                
                                <li>Average vs extremes.</li>
                                <li>Skill vs luck.</li>
                            </ul>
                        </li>                        
                    </ul>
